...
export const TruncatingNavbar: React.FC<TruncatingNavbarProps> = ({
  ...
  const handleKeydown = useCallback(
    (e: KeyboardEvent) => {
      if (
        (e.metaKey || e.ctrlKey) &&
        e.key.toUpperCase() === displayShortcutKey
      ) {
        e.preventDefault();
      ...
      >
        ...
        {!isMobile && (
          <>
            ...
            <Popover>
              <PopoverTrigger>
                <Avatar className="size-10 ml-3">
                  <AvatarFallback className="bg-black text-white text-lg dark:bg-white dark:text-black">
