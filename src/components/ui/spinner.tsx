...
export const Dots_v2 = (_props: SpinnerProps) => (
  <div className="flex items-center justify-center" {..._props}>
...
export const Dots_v3 = (_props: SpinnerProps) => {
  return (
    <div className="flex items-center justify-center space-x-2" {..._props}>
...
export const Dots_v5 = (_props: SpinnerProps) => {
  ...
  return (
    <div className="relative size-20 border" {..._props}>
      {[...Array(dots)].map((_, i) => {
